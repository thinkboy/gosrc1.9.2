...
const (
	...
	// 0xfffffade in hex.
	stackPreempt = uintptrMask & -1314 // stackPreempt是一个特殊的常量, 它的值会比任何的栈地址都要大, 检查时一定会触发栈扩张.
...
// 该函数在asm_amd64.s里的runtime·morestack()实现里调用。当需要更多栈空间的时候会被调用
